...
@section('contenido')
    ...
    <div class="container my-5">
        <div class="p-5 text-center bg-body-tertiary rounded-3">
            ...
            <div class="d-inline-flex gap-2 mb-5">
                <a href="https://github.com/Bartoloni00/bookstore" target="_blank" class="d-inline-flex align-items-center btn btn-primary btn-lg px-4 rounded-pill" type="button">
    ...
    <!--Inicio de la sección de personas-->
    <section class="row m-auto">
        <!--Inicio de la primera persona-->
        <div class="col-lg-6 text-center">
            <div class="redonditos">
                <img src="https://avatars.githubusercontent.com/u/116020038?v=4" alt="" loading="lazy" class />
            </div>
          <h2 class="fw-normal mt-2 mb-3">Abraham Bartoloni</h2>
          <p>Desarollador FullStack</p>
          <p><a class="btn btn-secondary" href="https://github.com/Bartoloni00" target="_blank"><i class="bi bi-github"></i> Visitar</a></p>
        </div>
        ...
        <div class="col-lg-6 text-center">
            <div class="redonditos">
                <img src="https://avatars.githubusercontent.com/u/111710833?s=400&u=7f1a1b29bfc2b8678dc5688a4311df4a6ebc4970&v=4" alt="" loading="lazy" />
            </div>
          <h2 class="fw-normal mt-2 mb-3">Ezequiel Arevalo</h2>
          <p>Desarollador FullStack</p>
          <p><a class="btn btn-secondary" href="https://github.com/Ezearevalodev" target="_blank"><i class="bi bi-github"></i> Visitar</a></p>
        </div>
