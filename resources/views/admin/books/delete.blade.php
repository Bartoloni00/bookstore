...
@section('contenido')
    ...
    <p class="text-danger text-center custom-text">¿Realmente estás  seguro de querer eliminar el libro: {{$book->title}}?</p>
    
    <form method="POST" action="{{url('/admin/books/'. $book->id .'/delete')}}" class="custom-forms">
      @csrf 
      <div class="mx-auto mb-3">
        <button type="submit" class="btn btn-danger mt-2 w-100 block m-auto">Sí, eliminar Libro</button>
      </div>
    </form>
@endsection